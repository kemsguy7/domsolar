  ...
  if(isset($_GET['id'])) {
    ...
    while($row = fetch_array($query)) {
      ...
      $product_quantity   = escape_string($row['product_quantity']);
       $product_image = display_image($row['product_image']); // image form name
...
<div class="form-group">
    ...
    <div class="form-group">
      ...
      <textarea name="product_short_desc" id="" cols="30" rows="3" class="form-control"><?php 
      echo $product_short_desc; ?> </textarea>
    </div>
...
<aside id="admin_sidebar" class="col-md-4">
    ...
    <div class="form-group">
        ...
        <select name="product_category_id" id="" class="form-control">
            ...
            <!-- The code above shows the curent category title in the category select form field  -->
...
<!-- Product Tags -->
   ...
   <!-- <div class="form-group">
    ...
    <div class="form-group">
        ...
        <?php//Image name is called using the display_image() function defined in the functions.php page ?>
        <img height="100" width="100" src="../../resources/<?php echo $product_image; ?>" alt=""> 
