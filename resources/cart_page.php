			...
			<div class="row">
				<div class="col-12">
					...
					<table class="table shopping-summery">
						...
						<tbody>
							<tr>
								<td class="image" data-title="No"><img src="images/camp.jpg" alt="#"></td>
								<td class="product-des" data-title="Description">
									<p class="product-name"><a href="#">Solar Fan</a></p>
									<p class="product-des">Solar fans for all weather including hot and cold.</p>
								</td>
								<td class="price" data-title="Price"><span><strike>N</strike>110.00 </span></td>
								...
								<td class="total-amount" data-title="Total"><span><strike>N</strike>220.88</span></td>
								<td class="action" data-title="Remove"><a href="#"><i class="ti-trash remove-icon"></i></a></td>
							</tr>
							<tr>
								<td class="image" data-title="No"><img src="images/camp.jpg" alt="#"></td>
								<td class="product-des" data-title="Description">
									<p class="product-name"><a href="#">Solar Camera</a></p>
									<p class="product-des">Solar Camera for videoing people and thingd.</p>
								</td>
								<td class="price" data-title="Price"><span><strike>N</strike>110.00 </span></td>
								<td class="qty" data-title="Qty"><!-- Input Order -->
									<div class="input-group">
						...
						<div class="row">
							<div class="col-lg-8 col-md-5 col-12">
								<div class="left">
									...
									<div class="checkbox">
										<label class="checkbox-inline" for="2"><input name="news" id="2" type="checkbox"> Shipping (+10<strike>N</strike>)</label>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li>Cart Subtotal<span><strike>N</strike>330.00</span></li>
